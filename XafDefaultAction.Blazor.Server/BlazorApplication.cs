...
namespace XafDefaultAction.Blazor.Server {
    public partial class XafDefaultActionBlazorApplication : BlazorApplication {
        public XafDefaultActionBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafDefaultActionBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
