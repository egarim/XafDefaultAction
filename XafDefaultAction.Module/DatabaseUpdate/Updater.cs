...
namespace XafDefaultAction.Module.DatabaseUpdate {
    ...
    public class Updater : ModuleUpdater {
        ...
        public override void UpdateDatabaseAfterUpdateSchema() {
            ...
            if(this.ObjectSpace.GetObjectsCount(typeof(DomainObject1),null)==0)
            {

                var Do1 = this.ObjectSpace.CreateObject<DomainObject1>();
                Do1.Name = "Do1";
                Do1.Code = "Do1";

                var Do2 = this.ObjectSpace.CreateObject<DomainObject2>();
                Do2.Name = "Do1";
                Do2.Code = "Do1";
            }
